def search_filters
  [
    { name: "Beer Garden", answer_ids: [34, 50, 267, 281, 306, 320, 321, 106, 136, 143, 145] },
    { name: "Beer Hall", answer_ids: [34, 49, 267, 268, 281, 306, 320, 321, 106, 142, 143, 145] },
    { name: "Bistros", answer_ids: [36, 49, 267, 269, 281, 288, 321, 322, 323, 331, 332, 84, 102, 105, 133] },
    { name: "Brasseries", answer_ids: [36, 49, 267, 269, 281, 288, 321, 322, 323, 331, 332] },
    { name: "Breakfast & Brunch", answer_ids: [34, 54, 58, 278, 284, 298, 319, 320, 321, 330, 331, 86, 87, 89, 100, 103, 106, 109, 124, 125, 126, 127] },
    { name: "Buffets", answer_ids: [36, 50, 278, 279, 280, 313, 319, 324, 329, 330, 331, 106, 144] },
    { name: "Cafes", answer_ids: [34, 267, 278, 320, 329, 330, 331, 86, 96, 109] },
    { name: "Themed Cafes", answer_ids: [322, 96, 110, 115] },
    { name: "Cafeteria", answer_ids: [50, 278, 284, 300, 305, 319, 324, 326, 333, 341, 81, 87, 89, 100, 106, 151, 152, 153] },
    { name: "Canteen", answer_ids: [266, 306, 151, 152, 153] },
    { name: "Chicken Shop", answer_ids: [36, 311, 101] },
    { name: "Comfort Food", answer_ids: [3, 36, 50, 55, 56, 269,
                                        278,
                                        280,
                                        295,
                                        338,
                                        ...
                                        143,
                                        145] },
    { name: "Creperies", answer_ids: [49, 54, 58, 267, 281, 296, 103, 110] },
    { name: "Delis", answer_ids: [34, 48, 55, 278, 294, 333, 349, 89, 106] },
    { name: "Diners", answer_ids: [36, 50, 55, 278, 284, 289, 294, 295, 300, 324, 329, 330] },
    { name: "Dinner Theater", answer_ids: [324, 331, 332, 144, 128, 129, 131] },
    { name: "Fast Food", answer_ids: [36, 50, 55, 57, 60, 278,
                                     289,
                                     294,
                                     303,
                                     301,
                                     ...
                                     152,
                                     153] },
    { name: "Food Court", answer_ids: [36, 50, 278,
                                      289,
                                      300,
                                      305,
                                      319,
                                      ...
                                      141,
                                      149] },
    { name: "Food Stands", answer_ids: [36, 60, 289, 320, 321, 329, 338, 348, 83, 94, 99, 100, 101, 107, 119, 138, 139, 140, 141, 149] },
    { name: "Gastropubs", answer_ids: [36, 281, 288, 306, 308, 320, 321, 338, 136, 143, 145] },
    { name: "Hong Kong Style Cafe", answer_ids: [2, 35, 47, 57, 267, 96] },
    { name: "Conveyor Belt Sushi", answer_ids: [34, 47, 267, 310, 335, 116] },
    { name: "Milk Bars", answer_ids: [34, 56, 308, 126, 127, 142, 143, 145] },
    { name: "Night Food", answer_ids: [36, 55, 57, 269, 270, 273, 281, 278, 300, 320, 329, 94] },
    { name: "Noodles", answer_ids: [35, 47, 57, 267, 348] },
    { name: "Open Sandwiches", answer_ids: [36, 55, 278, 294, 329, 349] },
    { name: "Parent Cafes", answer_ids: [305, 321, 322, 327] },
    { name: "Pop-Up Restaurants", answer_ids: [320, 321, 106, 115] },
    { name: "Poutineries", answer_ids: [36, 52, 55, 57, 267, 269, 281, 288, 294, 302] },
    { name: "Pub Food", answer_ids: [36, 50, 55, 57, 269, 278, 289, 294, 320, 321, 101, 133] },
    { name: "Soul Food", answer_ids: [3, 36, 50, 279, 83, 87, 94] },
    { name: "Steakhouses", answer_ids: [36, 50, 278, 288, 295, 302, 311, 321, 322, 323, 325, 332, 340, 84, 102, 93, 95, 117] },
    { name: "Supper Clubs", answer_ids: [36, 50, 323, 324, 325, 331, 332, 105] },
    { name: "Sushi Bars", answer_ids: [2, 34, 47, 60, 267, 310, 335, 110, 116] },
    { name: "Tapas Bars", answer_ids: [36, 57, 59, 267, 110] },
    { name: "Wok", answer_ids: [36, 47, 57, 267] },
    {
      name: "Afghan",
